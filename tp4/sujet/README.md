# Supports officiels — TP4 Monitoring, FinOps & Sécurité Azure

> Documents distribués dans le cadre du module EFREI. Cas fil rouge : **ShopEasy**.

| Fichier | Format | Description |
|---|---|---|
| [TP4_MonitoringFinOpsSecurite_Azure.md](TP4_MonitoringFinOpsSecurite_Azure.md) | Markdown | **Sujet du TP4** — ateliers, livrables, quiz, grille (transcription du PDF) |
...
| Scripts d'exploitation | [`../scripts/`](../scripts/) |
| Archive de rendu | [`../../dist/tp4/`](../../dist/tp4/) |
